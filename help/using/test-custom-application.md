---
title: Probar y depurar la aplicación personalizada [!DNL Asset Compute Service]
description: Probar y depurar la aplicación personalizada [!DNL Asset Compute Service].
